<?php
class M_reminder_belajar extends CI_Model
{
    public function get_datatables($bulan, $tahun, $status)
    {
        $this->db->select('lw.id_log, p.nama, lw.no_hp, lw.bulan, lw.tahun, lw.pesan, lw.response, lw.keterangan, lw.waktu_kirim');
        $this->db->from('reminder_belajar lw');
